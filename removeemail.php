...
<body>
	...
	<p>Please select the email addresses to delete from the email list and
		click Remove</p>

	<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
<?php
$dbc = mysqli_connect('localhost', 'id7371191_elmer', 'theking', 'id7371191_elvis_store') or die('Erro ao se conectar com o servidor MySQL.');
